...
/**
 * @ORM\Entity()
 * @ORM\Table(name="rednose_lox_share")
 */
class Share
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="Rednose\LoxBundle\Entity\Item")
     ...
     * @ORM\JoinTable(name="rednose_lox_shares_users",
     ...
     * @ORM\JoinTable(name="rednose_lox_shares_groups",
     *   joinColumns={@ORM\JoinColumn(name="share_id", referencedColumnName="id", onDelete="CASCADE")},
