...
/**
 * @ORM\Entity()
 * @ORM\Table(name="rednose_lox_item")
...
class Item
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Rednose\LoxBundle\Entity\Item", mappedBy="parent", cascade={"persist", "remove"})
     * @ORM\OrderBy({"title" = "ASC"})
     */
	protected $children;

    /**
     * @ORM\ManyToOne(targetEntity="Rednose\LoxBundle\Entity\Item", inversedBy="children")
     * @ORM\JoinColumn(name="parent_id", referencedColumnName="id", onDelete="CASCADE")
     */
	protected $parent;

    /**
     * @ORM\ManyToOne(targetEntity="Rednose\LoxBundle\Entity\Item", inversedBy="shares")
     * @ORM\JoinColumn(name="share_of_id", referencedColumnName="id", onDelete="CASCADE")
     */
    protected $shareOf;

    /**
     * @ORM\OneToMany(targetEntity="Rednose\LoxBundle\Entity\Item", mappedBy="shareOf")
     */
    protected $shares;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Rednose\LoxBundle\Entity\Revision", mappedBy="item", cascade={"persist", "remove"})
