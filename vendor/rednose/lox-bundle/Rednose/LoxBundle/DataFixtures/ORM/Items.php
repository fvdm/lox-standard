...
class Items extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    public function setContainer(ContainerInterface $container = null)
    {
        ...
        $this->im      = $container->get('rednose_lox.item_manager');
        $this->sm      = $container->get('rednose_lox.share_manager');
    ...
    public function load(ObjectManager $em)
    {
        ...
        $root = $em->getRepository('Rednose\LoxBundle\Entity\Item')->findOneByOwner($admin);
        ...
        $root = $em->getRepository('Rednose\LoxBundle\Entity\Item')->findOneByOwner($user);
        ...
        $invite = $em->getRepository('Rednose\LoxBundle\Entity\Invitation')->findOneByShare($share);
