...
class MetadataController extends Controller
{
    ...
    /**
     * @Route("/meta/{path}", name="rednose_lox_get_meta_path", requirements={"path" = ".+"}, defaults={"path" = "/"})
     * @Method({"GET"})
     */
    ...
    /**
     * @Route("/tree", name="rednose_lox_get_tree")
     * @Method({"GET"})
     */
     ...
     * @return Response
     *
     * @Get("/lox_api/meta/{path}", name="rednose_lox_api_get_meta_path", defaults={"path" = "/"}, requirements={"path" = ".+"})
     *
     ...
     *     output={ "class"="Rednose\LoxBundle\Entity\Item",
     *         "groups"={"details"}
     *     },
