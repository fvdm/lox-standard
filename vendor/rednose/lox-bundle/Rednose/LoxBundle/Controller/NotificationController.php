...
class NotificationController extends Controller
{
     ...
     *
     * @Route("/notifications", name="rednose_lox_get_notifications")
     * @Method({"GET"})
     */
    public function getNotificationsAction()
    {
        ...
        $notifications = $em->getRepository('Rednose\LoxBundle\Entity\Notification')->findBy(
            array('owner' => $user),
     ...
     *
     * @Route("/notifications/mark_read", name="rednose_lox_post_notifications_mark_read")
     * @Method({"POST"})
     */
    public function postNotificationsMarkReadAction()
    {
        ...
        $notifications = $em->getRepository('Rednose\LoxBundle\Entity\Notification')->findBy(array('owner' => $user));
     ...
     *
     * @Route("/notifications/unread", name="rednose_lox_get_notifications_unread")
     * @Method({"GET"})
     */
    public function getNotificationsUnread()
    {
        ...
        $notifications = $em->getRepository('Rednose\LoxBundle\Entity\Notification')->findBy(array(
            'owner'  => $user,
            'status' => 0,
        ));
