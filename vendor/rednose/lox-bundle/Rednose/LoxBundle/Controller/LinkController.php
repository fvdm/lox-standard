...
class LinkController extends Controller
{
    ...
    /**
     * @Route("/public/{path}", name="rednose_lox_links_path", requirements={"path" = ".+"})
     * @Method({"GET"})
     */
    ...
    /**
     * @Route("/links/create/{path}", name="rednose_lox_links_create", requirements={"path" = ".+"})
     * @Method({"GET"})
     */
    ...
    /**
     * @Route("/links/remove/{id}", name="rednose_lox_links_remove")
     * @Method({"POST"})
     */
     ...
     *
     * @Post("/links/{path}", name="rednose_lox_api_post_link", defaults={"path" = ""}, requirements={"path" = ".+"})
     *
     * @ApiDoc(
    ...
    protected function handleCreateLink($path, $api = false)
    {
        ...
        $url = $this->generateUrl('rednose_lox_links_path', array(
