...
namespace Rednose\LoxBundle\Tests\Entity;
...
class ItemManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->repository = $this->getMockBuilder('Doctrine\ORM\EntityRepository')
            ->disableOriginalConstructor()
            ->getMock();
        $this->class = 'Rednose\LoxBundle\Entity\Item';
    ...
    {
        return $this->getMock('Rednose\LoxBundle\Entity\ItemManager', array('getRootItem', 'saveItem'), array($this->em));
    }
