...
%post
cd %{_datadir}/localbox/
app/deployment/post-update2.sh 
...
%{_defaultdocdir}/localbox/html/doxygen.css
%{_defaultdocdir}/localbox/html/search/*.html
%{_defaultdocdir}/localbox/html/search/*.js
%{_defaultdocdir}/localbox/html/search/*.png
%{_defaultdocdir}/localbox/html/search/search.css
%{_defaultdocdir}/localbox/html/tabs.css
